						...
						<div id="wpsight-latest-listings-2-wrap" class="widget-wrap widget-latest-wrap">
							...
							<div id="divContentPanelPrincipal">
								<div id="divContentPanelSolicitantes">
									<h1 class="big_title">Mis Solicitantes</h1>
									<div id="divLoading"></div>
									<ul class="ulSolicitantes">
										<?
										if($opcion=="cpago"){
											?>
											<li class="liResaltado"><a href="<? echo base_url()?>solicitantes/index/spago">Solicitantes por Comprar</a></li>
											<li class="liNoResaltado">Solicitantes Comprados</li>
											<?
										}else
											if($opcion=="spago"){
												?>
												<li class="liNoResaltado">Solicitantes por Comprar</li>
												<li class="liResaltado"><a href="<? echo base_url()?>solicitantes/index/cpago">Solicitantes Comprados</a></li>
											<?
										}
										?>
  									</ul>
