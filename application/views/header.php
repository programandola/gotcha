					...
					<?php
						if( $this->session->userdata('login') ){
							...
							if( $this->session->userdata('nivelUser') == 1){
								?>
								<li id="menu-item-21" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-21"><a href="<?php echo base_url()?>anunciar" title="Registra tu Campo">Registra tu Campo</a></li>
								<?php
							}
						}
						else{
						...
						<li id="open-registro" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-21"><a href="#" title="Registra tu Campo">Registra tu Campo</a></li>
				<?php
				}
				?>
				</ul>
